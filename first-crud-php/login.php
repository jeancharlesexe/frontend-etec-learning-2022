        ...
        <nav class="navbar navbar-expand-lg bg-light ">
            ...
            <a class="navbar-brand" href="#"><i class="fa-solid fa-fire"></i> FireHouse</a>
                ...
                <ul class="navbar-nav mr-auto" style="margin-left: auto;">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="page-client/produtos.php">Produtos</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            ...
            <h2 class="h1-responsive font-weight-bold text-center my-4">Login</h2>
                <div class="card" style="width: 20rem;  margin: 0 auto 0 auto;">
                    <div class="card-body">
                    <form method="post" action="page-client/verifica-login-cliente.php">
                        <div class="mb-3">
                        ...
                        <p style="font-size:12px;" class="text-center">Não tem conta ainda?<a href="cadastro.php" class="link-registration"> Clique aqui.</a></p>
                    </form>
                    </div>
                </div>
            </div>
