...
<html lang="pt-br">
  ...
  <body>
    ...
    <main>
        <h4 class="h1-responsive font-weight-bold text-center my-4">Clientes</h2>
        <?php
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $cliente['nomecliente']; ?>
                            <td><?php echo $cliente['usuariocliente']; ?> </td>
                            <td><?php echo $cliente['emailcliente']; ?> </td>
                            <td>
                                <button type="button" class="btn btn-danger text-light" data-bs-toggle="modal" data-bs-target="#deletar<?php echo $cliente['idcliente']; ?>">
                                <span>Banir</span> <i class="fa fa-trash"></i>
                                </button>

                                <div class="modal fade" id="deletar<?php echo $cliente['idcliente']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        Você deseja banir este usuário permanentemente?
                                    </div>
                                    <div class="modal-footer">
                                    <form method="post" action="banir-cliente.php">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                                        <button type="submit" class="btn btn-danger" name="del" value="<?php echo $cliente['idcliente']; ?>" >
                                            Deletar
                                        </button>
                                    </form>
                                    </div>
