...
<header>
        <nav class="navbar navbar-expand-lg bg-light ">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><i class="fa-solid fa-fire"></i> Ecommerce</a>
                ...
                <ul class="navbar-nav mr-auto" style="margin-left: auto;">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="page-admin/login-admin.php">Administrador</a></li>
                    </ul>
                    </div>
                </ul>
                </div>
    ...
    <main>
        ...
        <div class="row">
            <div class="col">
            <h2 class="h1-responsive font-weight-bold text-center my-4">Administração</h2>
                <div class="card" style="width: 20rem;  margin: 0 auto 0 auto;">
                    <div class="card-body">
                    <form method="post" action="verifica-login-admin.php">
                        <div class="mb-3">
                            <label class="form-label">Administrador</label>
                            <input type="text" class="form-control" id="user-admin" name="user-admin">
                        </div>
                        <div class="mb-3">
